...
internal class ToolsEf
{
    ...
    /// <param name="color">Цвет текста (по умолчанию красный).</param>
    /// <param name="isLine">Флаг, определяющий вывод строки или символа.</param>
    public static void DisplayColor(string message, System.ConsoleColor color = ConsoleColor.Red, bool isLine = true)
    {
    ...
    {
        return Regex.IsMatch(text, ToolsEf.Pattern);
    }
    ...
    {
        return Regex.Replace(text, ToolsEf.Pattern, ToolsEf.Target);
    }
